    ...
    <head>
        ...
        <style>
            html, body {
                ...
                background-image:url('icon/hkustbg3.jpg');             
            }
    ...
    <div class="row justify-content-center">
        <div class="col-md-8" style="padding-top:200px">
            <div class="card">
                ...
                <div class="card-header" style="color:#FFFFFF" align=center><strong>Create Account</strong></div>
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('E-Mail Address') }} <strong class="text-danger">*</strong></label>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Confirm Password') }} <strong class="text-danger">*</strong></label>
